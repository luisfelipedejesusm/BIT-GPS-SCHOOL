...
public class detalle_rutas_adapter extends ArrayAdapter<detalleRuta_model>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView image = (ImageView) listItemView.findViewById(R.id.imageViewlistEvento);

        if(CurrentRoute.getEstatus()==0){
            listItemView.setBackgroundColor(ContextCompat.getColor(getContext(),R.color.Red_Crimson2));
            image.setImageResource(R.mipmap.ic_clear_black_24dp);
            ...
            image.setImageResource(R.mipmap.ic_done_black_24dp);
            ...
            image.setImageResource(R.mipmap.ic_school_black_24dp);
